...
const Navbar = () => {
  ...
  return (
    <Container>
      <nav className="h-24 pt-10 flex items-center justify-between bg-white px-4 py-2 text-black mb-24 sticky top-0">
        {/* logo */}
        ...
        >
          ...
          {dropDownState && (
            <div className="z-10  gap-2  bg-[#393E46]  absolute right-0 top-11 flex w-[200px] flex-col  rounded-lg   text-base">
              <ul className="  ">
